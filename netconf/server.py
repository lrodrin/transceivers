...
class SystemServer(object):
    ...
    @staticmethod
    def nc_append_capabilities(capabilities):  # pylint: disable=W0613
    ...
    def rpc_get(self, rpc, filter_or_none):  # pylint: disable=W0613
    ...
    @staticmethod
    def rpc_get_config(rpc, filter_or_none):  # pylint: disable=W0613
