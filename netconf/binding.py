...
class yc_nominal_central_frequency_node_topology__node_port_available_core_available_frequency_slot_nominal_central_frequency(PybindBase):
  """
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__channel_number = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="channel-number", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    self.__adjustment_granularity = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="adjustment-granularity", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    self.__grid_type = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="grid-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
  ...
  def _set_grid_type(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="grid-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
  ...
  def _set_adjustment_granularity(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="adjustment-granularity", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
  ...
  def _set_channel_number(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="channel-number", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
  ...
  _pyangbind_elements = OrderedDict([('grid_type', grid_type), ('adjustment_granularity', adjustment_granularity), ('channel_number', channel_number), ])
...
class yc_available_frequency_slot_node_topology__node_port_available_core_available_frequency_slot(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__nominal_central_frequency = YANGDynClass(base=yc_nominal_central_frequency_node_topology__node_port_available_core_available_frequency_slot_nominal_central_frequency, is_container='container', yang_name="nominal-central-frequency", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:node-topology', defining_module='node-topology', yang_type='container', is_config=True)
    self.__slot_id = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="slot-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    self.__slot_width_number = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="slot-width-number", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
  ...
  def _set_slot_id(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="slot-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
  ...
  def _set_nominal_central_frequency(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=yc_nominal_central_frequency_node_topology__node_port_available_core_available_frequency_slot_nominal_central_frequency, is_container='container', yang_name="nominal-central-frequency", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:node-topology', defining_module='node-topology', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
  ...
  def _set_slot_width_number(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="slot-width-number", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
  ...
  _pyangbind_elements = OrderedDict([('slot_id', slot_id), ('nominal_central_frequency', nominal_central_frequency), ('slot_width_number', slot_width_number), ])


class yc_nominal_central_frequency_node_topology__node_port_available_core_occupied_frequency_slot_nominal_central_frequency(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
...
class yc_occupied_frequency_slot_node_topology__node_port_available_core_occupied_frequency_slot(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__nominal_central_frequency = YANGDynClass(base=yc_nominal_central_frequency_node_topology__node_port_available_core_occupied_frequency_slot_nominal_central_frequency, is_container='container', yang_name="nominal-central-frequency", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:node-topology', defining_module='node-topology', yang_type='container', is_config=True)
    self.__slot_id = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="slot-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    self.__slot_width_number = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="slot-width-number", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
  ...
  def _set_nominal_central_frequency(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=yc_nominal_central_frequency_node_topology__node_port_available_core_occupied_frequency_slot_nominal_central_frequency, is_container='container', yang_name="nominal-central-frequency", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:node-topology', defining_module='node-topology', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """nominal_central_frequency must be of a type compatible with container""",
          'defined-type': "container",
...
class yc_available_core_node_topology__node_port_available_core(PybindBase):
  ...
  def _set_core_id(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="core-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
  ...
  _pyangbind_elements = OrderedDict([('core_id', core_id), ('available_frequency_slot', available_frequency_slot), ('occupied_frequency_slot', occupied_frequency_slot), ])


class yc_supported_modulation_format_node_topology__node_port_available_transceiver_supported_modulation_format(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__mod_type = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="mod-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    self.__modulation_id = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="modulation-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
  ...
  def _set_modulation_id(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="modulation-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
  ...
  def _set_mod_type(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="mod-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
...
class yc_supported_center_frequency_range_node_topology__node_port_available_transceiver_supported_center_frequency_range(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__max_cf = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="max-cf", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    self.__min_cf = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="min-cf", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
  ...
  def _set_max_cf(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="max-cf", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
  ...
  def _set_min_cf(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="min-cf", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
...
class yc_supported_bandwidth_node_topology__node_port_available_transceiver_supported_bandwidth(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__min_bw = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="min-bw", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    self.__max_bw = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="max-bw", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
  ...
  def _set_max_bw(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="max-bw", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
  ...
  def _set_min_bw(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="min-bw", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
...
class yc_available_transceiver_node_topology__node_port_available_transceiver(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_path_helper', '_extmethods', '__transceiver_id','__transceiver_type','__supported_modulation_format','__supported_center_frequency_range','__supported_bandwidth','__supported_FEC','__supported_equalization','__supported_monitoring',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__supported_bandwidth = YANGDynClass(base=yc_supported_bandwidth_node_topology__node_port_available_transceiver_supported_bandwidth, is_container='container', yang_name="supported-bandwidth", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:node-topology', defining_module='node-topology', yang_type='container', is_config=True)
    self.__transceiver_id = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="transceiver-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    self.__supported_FEC = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="supported-FEC", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    self.__transceiver_type = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="transceiver-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    self.__supported_center_frequency_range = YANGDynClass(base=yc_supported_center_frequency_range_node_topology__node_port_available_transceiver_supported_center_frequency_range, is_container='container', yang_name="supported-center-frequency-range", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:node-topology', defining_module='node-topology', yang_type='container', is_config=True)
    self.__supported_equalization = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="supported-equalization", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    self.__supported_monitoring = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="supported-monitoring", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    self.__supported_modulation_format = YANGDynClass(base=yc_supported_modulation_format_node_topology__node_port_available_transceiver_supported_modulation_format, is_container='container', yang_name="supported-modulation-format", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:node-topology', defining_module='node-topology', yang_type='container', is_config=True)
  ...
  def _set_transceiver_id(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="transceiver-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
  ...
  def _set_transceiver_type(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="transceiver-type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
  ...
  def _set_supported_modulation_format(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=yc_supported_modulation_format_node_topology__node_port_available_transceiver_supported_modulation_format, is_container='container', yang_name="supported-modulation-format", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:node-topology', defining_module='node-topology', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
  ...
  def _set_supported_center_frequency_range(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=yc_supported_center_frequency_range_node_topology__node_port_available_transceiver_supported_center_frequency_range, is_container='container', yang_name="supported-center-frequency-range", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:node-topology', defining_module='node-topology', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
  ...
  def _set_supported_bandwidth(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=yc_supported_bandwidth_node_topology__node_port_available_transceiver_supported_bandwidth, is_container='container', yang_name="supported-bandwidth", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:node-topology', defining_module='node-topology', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
  ...
  def _set_supported_FEC(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="supported-FEC", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
  ...
  def _set_supported_equalization(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="supported-equalization", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
  ...
  def _set_supported_monitoring(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="supported-monitoring", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
  ...
  supported_modulation_format = __builtin__.property(_get_supported_modulation_format, _set_supported_modulation_format)
  supported_center_frequency_range = __builtin__.property(_get_supported_center_frequency_range, _set_supported_center_frequency_range)
  ...
  _pyangbind_elements = OrderedDict([('transceiver_id', transceiver_id), ('transceiver_type', transceiver_type), ('supported_modulation_format', supported_modulation_format), ('supported_center_frequency_range', supported_center_frequency_range), ('supported_bandwidth', supported_bandwidth), ('supported_FEC', supported_FEC), ('supported_equalization', supported_equalization), ('supported_monitoring', supported_monitoring), ])
...
class yc_port_node_topology__node_port(PybindBase):
  ...
  YANG type.
  """
  __slots__ = ('_path_helper', '_extmethods', '__port_id','__layer_protocol_name','__available_core','__available_transceiver',)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__layer_protocol_name = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="layer-protocol-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    self.__port_id = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="port-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    self.__available_transceiver = YANGDynClass(base=yc_available_transceiver_node_topology__node_port_available_transceiver, is_container='container', yang_name="available-transceiver", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:node-topology', defining_module='node-topology', yang_type='container', is_config=True)
    self.__available_core = YANGDynClass(base=YANGListType("core_id",yc_available_core_node_topology__node_port_available_core, yang_name="available-core", parent=self, is_container='list', user_ordered=False, path_helper=self._path_helper, yang_keys='core-id', extensions=None), is_container='list', yang_name="available-core", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:node-topology', defining_module='node-topology', yang_type='list', is_config=True)
  ...
  def _set_port_id(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="port-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, is_keyval=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
  ...
  def _set_layer_protocol_name(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="layer-protocol-name", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
  ...
  _pyangbind_elements = OrderedDict([('port_id', port_id), ('layer_protocol_name', layer_protocol_name), ('available_core', available_core), ('available_transceiver', available_transceiver), ])
...
class yc_node_node_topology__node(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__node_id = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="node-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
  ...
  def _set_node_id(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="node-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='urn:node-topology', defining_module='node-topology', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
...
class node_topology(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self._extmethods = False
    self.__node = YANGDynClass(base=yc_node_node_topology__node, is_container='container', yang_name="node", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:node-topology', defining_module='node-topology', yang_type='container', is_config=True)
  ...
  def _set_node(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=yc_node_node_topology__node, is_container='container', yang_name="node", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, extensions=None, namespace='urn:node-topology', defining_module='node-topology', yang_type='container', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
